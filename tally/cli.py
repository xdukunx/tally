...
def _submit(argv) -> int:
    p = argparse.ArgumentParser(prog="tally submit", description="Queue a job to run when resources free up.")
    p.add_argument("--cores", type=int, required=True, help="CPU cores the job needs")
